...
{
    public partial class ConfigurationView : BaseConsoleCustomView
    {
        ...
        public ConfigurationView(long configurationKey)
        {
        ...
        {
            UtilPopup utilPopup = new UtilPopup(UtilPopupType.MESSAGE,"¿Seguro que desea grabar los cambios?");
            ...
            if (utilPopup.DialogResult == DialogResult.OK)
            {
                ...
                //long addConfigurationKey = Connection.Instance.SelectAddOnConfigurationKey();
